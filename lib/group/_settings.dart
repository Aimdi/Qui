                  ...
                  return Column(
                    children: [
                      SwitchListTile(
                        ...
                        onChanged: (value) async => await model
                            .toggleSubscriptionGroupIncludeReplies(value),
                      ),
                      SwitchListTile(
                        title: Text(L10n.of(context).include_retweets),
                        value: includeRetweets,
                        onChanged: (value) async => await model
                            .toggleSubscriptionGroupIncludeRetweets(value),
                      ),
                      ExpansionTile(
                        ...
                        children: [
                          RadioListTile<int>(
                            ...
                            onChanged: (_) async => await model
                                .toggleSubscriptionGroupPopular(false),
                          ),
                          RadioListTile<int>(
                            ...
                            groupValue: _sortModeOf(model.state),
                            onChanged: (_) async => await model
                                .toggleSubscriptionGroupPopular(true),
                          ),
                          RadioListTile<int>(
                            ...
                            secondary: IconButton(
                              ...
                              onPressed: () async {
                                if (!model.state.custom) {
                                  await model.toggleSubscriptionGroupCustom(
                                    true,
                                  );
                                }
                                if (context.mounted) {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => GroupCustomSettingsScreen(
                                        model: model,
                                      ),
                                    ),
                                  );
